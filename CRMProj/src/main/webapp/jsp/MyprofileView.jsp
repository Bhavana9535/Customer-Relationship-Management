...
<form action="<%=CRMView.MYPROFILE_CTL%>" method="post">
          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">MyProfile</p>
...
<div class="form-check d-flex justify-content-center mb-5">
                    ...
                    <input type="submit" class="btn btn-primary btn-lg" name="operation" value="<%=MyProfileCtl.OP_UPDATE%>">
                  </div>
